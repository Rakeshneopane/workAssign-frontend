...
//                 <div className="rounded-2xl border border-slate-200 bg-gradient-to-r from-blue-600 to-indigo-600 p-8 text-white mb-8">
...
//                         <AdminOnly>
//                             <button 
//                                 onClick={(e)=> navigate(`/dashboard/projects/${project._id}/edit`)}
